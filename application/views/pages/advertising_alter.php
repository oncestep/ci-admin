...
<div class="wrap">
    ...
    <form id="alter_form" method="post" accept-charset="utf-8" target="_self" action="<?php echo site_url('passage/save/'.$passage_id)?>">
        <table class="noborder">
            <tr>
                <td style="text-align:right;"><b>文章标题：</b></td>
                <td><input name="title" class="passage_headline" value="<?php echo $passage_title?>" type="text" placeholder="请输入文章标题"/></td>
            </tr>
            <tr>
                ...
                <td>
                    <script name="content" class="editor_box" type="text/plain" id="container" name="content"><?php echo $passage_content?></script>
                </td>
            </tr>
            <tr>
                <td style="text-align:right;"></td>
                <td class="btn_right">
                    <button type="button" class="btn btn-warning" id="btn_delete"><?php echo anchor('passage/delete/'.$passage_id.'/'.$admin_id,'删除 (DELETE)')?></button>
                    <button type="submit" class="btn btn-primary">确认修改 (UPLOAD)</button>
                </td>
            </tr>
        </table>
    </form>
