...
<div class="wrap">
    ...
    <form method="post" enctype="multipart/form-data" accept-charset="utf-8" target="_self" action="<?=site_url('product/save/'.$info['product_id'])?>">
        <table class="list-style">
            <tr>
                <td style="text-align:right;width:15%;">产品名称：</td>
                <td><input name="product_name" type="text" class="textBox length-long" placeholder="请输入产品名称" value="<?=$info['product_name']?>"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input name="product_price" type="text" class="textBox length-short" placeholder="价格" value="<?= $info['product_price']?>"/>
                    <span>元</span>
            </tr>
            <tr>
                <td style="text-align:right;">库存：</td>
                <td>
                    <input name="product_num" type="text" class="textBox length-short" placeholder="库存" value="<?= $info['product_quantity']?>"/>
                    <span>件</span>
                </td>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <script class="editor_box" type="text/plain" id="container" name="container"><?= $info['product_content']?></script>
                </td>
            </tr>
            <tr>
                <td style="text-align:right;"></td>
